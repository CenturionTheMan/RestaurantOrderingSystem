...
{
    mvwvline(contentWindow, 2, contentWindow->_maxx - 2, (int)'#', 3);
    mvwvline(contentWindow, 2, contentWindow->_maxx - 9, (int)'#', 3);
    mvwprintw(contentWindow, 3, contentWindow->_maxx - 8, "FRIDGE");
    mvwhline(contentWindow, 2, contentWindow->_maxx - 9, (int)'#', 8);
    mvwhline(contentWindow, 4, contentWindow->_maxx - 9, (int)'#', 8);
    mvwprintw(contentWindow, 5, contentWindow->_maxx - 8, "COOKS WAITING:   ");
