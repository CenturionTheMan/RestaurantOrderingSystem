...
void GuiNcurses::DrawContent()
{
    ...
    //DRAW OVENS + 10
    mvwvline(contentWindow, 12, contentWindow->_maxx - 10, (int)'#', 3);
    mvwvline(contentWindow, 12, contentWindow->_maxx - 19, (int)'#', 3);
    mvwprintw(contentWindow, 13, contentWindow->_maxx - 18, " OVENS ");
    mvwhline(contentWindow, 12, contentWindow->_maxx - 19, (int)'#', 9);
    mvwhline(contentWindow, 14, contentWindow->_maxx - 19, (int)'#', 9);
