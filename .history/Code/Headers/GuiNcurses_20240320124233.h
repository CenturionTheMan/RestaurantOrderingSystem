...
void GuiNcurses::DrawContent()
{
    ...
    //DRAW OVENS + 10
    mvwvline(contentWindow, 22, contentWindow->_maxx - 10, (int)'#', 3);
    mvwvline(contentWindow, 22, contentWindow->_maxx - 19, (int)'#', 3);
    mvwprintw(contentWindow, 23, contentWindow->_maxx - 18, " OVENS ");
    mvwhline(contentWindow, 22, contentWindow->_maxx - 19, (int)'#', 9);
    mvwhline(contentWindow, 24, contentWindow->_maxx - 19, (int)'#', 9);
    mvwprintw(contentWindow, 25, contentWindow->_maxx - 19, "COOKS: ???");


    //DRAW OVENS
    mvwvline(contentWindow, 2, contentWindow->_maxx - 30, (int)'#', 3);
    mvwvline(contentWindow, 2, contentWindow->_maxx - 39, (int)'#', 3);
    mvwprintw(contentWindow, 3, contentWindow->_maxx - 38, " OVENS ");
    mvwhline(contentWindow, 2, contentWindow->_maxx - 39, (int)'#', 9);
    mvwhline(contentWindow, 4, contentWindow->_maxx - 39, (int)'#', 9);
    mvwprintw(contentWindow, 5, contentWindow->_maxx - 39, "COOKS: ???");
