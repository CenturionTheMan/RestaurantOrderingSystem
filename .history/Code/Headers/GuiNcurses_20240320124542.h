...
void GuiNcurses::DrawContent()
{
    ...
    mvwprintw(contentWindow, 13, contentWindow->_maxx - 18, " GOING TO ");
    mvwprintw(contentWindow, 14, contentWindow->_maxx - 18, "  FRIDGE  ");
    mvwhline(contentWindow, 12, contentWindow->_maxx - 19, (int)'#', 11);
    mvwhline(contentWindow, 16, contentWindow->_maxx - 19, (int)'#', 11);
    mvwprintw(contentWindow, 17, contentWindow->_maxx - 19, "COOKS: ???"); 
