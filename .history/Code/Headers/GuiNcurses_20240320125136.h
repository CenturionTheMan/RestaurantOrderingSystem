...
void GuiNcurses::DrawContent()
{
    ...
    //DRAW BUFFET
    mvwvline(contentWindow, 22, 5, (int)'#', 3);
    mvwvline(contentWindow, 22, 16, (int)'#', 3);
    mvwprintw(contentWindow, 23, 6, "  BUFFET  ");
    mvwhline(contentWindow, 22, 5, (int)'#', 11);
    mvwhline(contentWindow, 24, 5, (int)'#', 11);
    mvwprintw(contentWindow, 25, 5, "CLIENTS: ???");
    mvwprintw(contentWindow, 26, 5, "COOKS:   ???");
