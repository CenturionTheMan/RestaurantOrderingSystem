...
void GuiNcurses::DrawContent()
{
    ...
    //DRAW BUFFET
    mvwvline(contentWindow, 19, 5, (int)'#', 3);
    mvwvline(contentWindow, 19, 16, (int)'#', 3);
    mvwprintw(contentWindow, 20, 6, "  BUFFET  ");
    mvwhline(contentWindow, 19, 5, (int)'#', 11);
    mvwhline(contentWindow, 21, 5, (int)'#', 11);
    mvwprintw(contentWindow, 22, 5, "CLIENTS: ???");
    mvwprintw(contentWindow, 23, 5, "COOKS:   ???");
