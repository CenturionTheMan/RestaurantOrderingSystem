...
void GuiNcurses::DrawContent()
{
    ...
    mvwvline(contentWindow, 11, 30, (int)'#', 3);
    mvwvline(contentWindow, 11, 41, (int)'#', 3);
    mvwprintw(contentWindow, 11, 31, " GOING TO ");
    mvwprintw(contentWindow, 12, 31, "  BUFFET  ");
    mvwhline(contentWindow, 11, 30, (int)'#', 12);
    mvwhline(contentWindow, 14, 30, (int)'#', 12);
    mvwprintw(contentWindow, 15, 30, "CLIENTS: ???");
