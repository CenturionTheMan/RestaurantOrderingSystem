...
void GuiNcurses::DrawContent()
{
    ...
    mvwvline(contentWindow, 3, 41, (int)'#', 3);
    mvwprintw(contentWindow, 4, 31, " MANAGER ");
    mvwhline(contentWindow, 3, 30, (int)'#', 12);
    mvwhline(contentWindow, 5, 30, (int)'#', 12);
    mvwprintw(contentWindow, 6, 30, "STATE: ????????");
