...
void GuiNcurses::DrawContent()
{
    ...
    //DRAW MANAGER
    mvwvline(contentWindow, 3, 30, (int)'#', 3);
    mvwvline(contentWindow, 3, 21, (int)'#', 3);
    mvwprintw(contentWindow, 4, 21, " MANAGER ");
    mvwhline(contentWindow, 3, 20, (int)'#', 12);
    mvwhline(contentWindow, 6, 20, (int)'#', 12);
    mvwprintw(contentWindow, 5, 20, "STATE: ????????");
