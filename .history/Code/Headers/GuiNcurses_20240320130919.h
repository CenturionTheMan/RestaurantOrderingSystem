...
{
    //DRAW FRIDGE
    mvwvline(contentWindow, 3, contentWindow->_maxx - 8, (int)'#', 3);
    mvwvline(contentWindow, 3, contentWindow->_maxx - 17, (int)'#', 3);
    mvwprintw(contentWindow, 4, contentWindow->_maxx - 16, " FRIDGE ");
    mvwhline(contentWindow, 3, contentWindow->_maxx - 17, (int)'#', 9);
    mvwhline(contentWindow, 5, contentWindow->_maxx - 17, (int)'#', 9);
    mvwprintw(contentWindow, 6, contentWindow->_maxx - 17, "COOKS: ???");

    //DRAW WALKING COOKS TO FRIDGE
    mvwvline(contentWindow, 11, contentWindow->_maxx - 6, (int)'#', 3);
    mvwvline(contentWindow, 11, contentWindow->_maxx - 17, (int)'#', 3);
    mvwprintw(contentWindow, 12, contentWindow->_maxx - 16, " GOING TO ");
    mvwprintw(contentWindow, 13, contentWindow->_maxx - 16, "  FRIDGE  ");
    mvwhline(contentWindow, 11, contentWindow->_maxx - 17, (int)'#', 12);
    mvwhline(contentWindow, 14, contentWindow->_maxx - 17, (int)'#', 12);
    mvwprintw(contentWindow, 15, contentWindow->_maxx - 17, "COOKS: ???"); 

    //DRAW OVENS
    mvwvline(contentWindow, 20, contentWindow->_maxx - 8, (int)'#', 3);
    mvwvline(contentWindow, 20, contentWindow->_maxx - 17, (int)'#', 3);
    mvwprintw(contentWindow, 21, contentWindow->_maxx - 16, " OVENS ");
    mvwhline(contentWindow, 20, contentWindow->_maxx - 17, (int)'#', 9);
    mvwhline(contentWindow, 22, contentWindow->_maxx - 17, (int)'#', 9);
    mvwprintw(contentWindow, 23, contentWindow->_maxx - 17, "COOKS: ???");
    ...
    //DRAW MANAGER
    mvwprintw(contentWindow, 12, 27, "MANAGER STATE:");
    mvwhline(contentWindow, 11, 27, (int)'#', 18);
    mvwhline(contentWindow, 14, 27, (int)'#', 18);
    mvwprintw(contentWindow, 13, 27, "adding ingredients");
