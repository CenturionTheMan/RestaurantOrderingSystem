...
void GuiNcurses::DrawLeft()
{
    ...
    mvwprintw(leftWindow, 4, 2, "- Banana: ");
    mvwprintw(leftWindow, 4, 2, "- Blueberry: ");
    mvwprintw(leftWindow, 4, 2, "- Chocolate: ");
    mvwprintw(leftWindow, 4, 2, "- Eggs/Milk/Flour: ");
...
GuiNcurses::GuiNcurses()
{
    ...
    bottomWindow = newwin(WINDOW_HEIGHT/10, WINDOW_WIDTH - WINDOW_WIDTH/4, WINDOW_HEIGHT - WINDOW_HEIGHT/10, WINDOW_START_X);
    leftWindow = newwin(WINDOW_HEIGHT - WINDOW_HEIGHT/10, WINDOW_WIDTH/4, WINDOW_START_Y, WINDOW_START_X);
    refresh();
