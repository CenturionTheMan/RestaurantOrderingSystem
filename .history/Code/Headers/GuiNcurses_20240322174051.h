...
void GuiNcurses::DrawLeft()
{
    ...
    mvwprintw(leftWindow, 4, 2, bananaStr.c_str());
    mvwprintw(leftWindow, 5, 2, blueberryStr.c_str());
    mvwprintw(leftWindow, 6, 2, chocolateStr.c_str());
    mvwprintw(leftWindow, 7, 2, commonsStr.c_str());
