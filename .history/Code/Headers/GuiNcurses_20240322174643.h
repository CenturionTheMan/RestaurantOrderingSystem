...
GuiNcurses::GuiNcurses()
{
    ...
    contentWindow  = newwin(WINDOW_HEIGHT-WINDOW_HEIGHT/5, WINDOW_WIDTH-WINDOW_WIDTH/4, WINDOW_START_Y, WINDOW_START_X + WINDOW_WIDTH/4);
    bottomWindow = newwin(WINDOW_HEIGHT/5, WINDOW_WIDTH - WINDOW_WIDTH/4, WINDOW_HEIGHT - WINDOW_HEIGHT/5, WINDOW_START_X);
    leftWindow = newwin(WINDOW_HEIGHT - WINDOW_HEIGHT/5, WINDOW_WIDTH/4, WINDOW_START_Y, WINDOW_START_X);
    refresh();
