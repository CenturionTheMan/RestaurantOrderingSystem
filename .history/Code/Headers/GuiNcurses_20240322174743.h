...
void GuiNcurses::DrawLeft()
{
    ...
    mvwprintw(leftWindow, 4, 2, "%s", bananaStr.c_str());
...
GuiNcurses::GuiNcurses()
{
    ...
    contentWindow  = newwin(WINDOW_HEIGHT-WINDOW_HEIGHT/9, WINDOW_WIDTH-WINDOW_WIDTH/3, WINDOW_START_Y, WINDOW_START_X + WINDOW_WIDTH/3);
    bottomWindow = newwin(WINDOW_HEIGHT/9, WINDOW_WIDTH - WINDOW_WIDTH/3, WINDOW_HEIGHT - WINDOW_HEIGHT/9, WINDOW_START_X);
    leftWindow = newwin(WINDOW_HEIGHT - WINDOW_HEIGHT/9, WINDOW_WIDTH/3, WINDOW_START_Y, WINDOW_START_X);
    refresh();
