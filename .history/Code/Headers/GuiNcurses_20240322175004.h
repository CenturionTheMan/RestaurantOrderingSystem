...
GuiNcurses::GuiNcurses()
{
    ...
    bottomWindow = newwin(WINDOW_HEIGHT/9, WINDOW_WIDTH, WINDOW_HEIGHT - WINDOW_HEIGHT/9, WINDOW_START_X);
    leftWindow = newwin(WINDOW_HEIGHT - WINDOW_HEIGHT/9, WINDOW_WIDTH*3/5, WINDOW_START_Y, WINDOW_START_X);
    refresh();
