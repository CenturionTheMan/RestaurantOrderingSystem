...
GuiNcurses::GuiNcurses()
{
    ...
    contentWindow  = newwin(WINDOW_HEIGHT*9/10, WINDOW_WIDTH*3/5, WINDOW_START_Y, WINDOW_START_X + WINDOW_WIDTH*1/5);
    bottomWindow = newwin(WINDOW_HEIGHT*1/10, WINDOW_WIDTH, WINDOW_HEIGHT - WINDOW_HEIGHT/9, WINDOW_START_X);
