...
GuiNcurses::GuiNcurses()
{
    ...
    contentWindow  = newwin(WINDOW_HEIGHT*9/10, WINDOW_WIDTH*5/10, WINDOW_START_Y, WINDOW_START_X + WINDOW_WIDTH*3/10);
    bottomWindow = newwin(WINDOW_HEIGHT*1/10, WINDOW_WIDTH, WINDOW_HEIGHT*9/10, WINDOW_START_X);
    leftWindow = newwin(WINDOW_HEIGHT*9/10, WINDOW_WIDTH*2/10, WINDOW_START_Y, WINDOW_START_X);
    refresh();
