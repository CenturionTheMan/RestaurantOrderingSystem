...
void GuiNcurses::DrawRight()
{
    ...
    mvwprintw(rightWindow, 10, 2, "%s", (COMMAND_DELETE_COOK_BANANA + "^X").data());
    mvwprintw(rightWindow, 11, 2, "%s", (COMMAND_DELETE_COOK_CHOCOLATE + "^X").data());
    mvwprintw(rightWindow, 12, 2, "%s", (COMMAND_DELETE_COOK_BLUEBERRY + "^X").data());
    mvwprintw(rightWindow, 13, 2, "%s", (COMMAND_SET_FRIDGE_LIMIT_BANANA + "^X").data());
    mvwprintw(rightWindow, 14, 2, "%s", (COMMAND_SET_FRIDGE_LIMIT_CHOCOLATE + "^X").data());
    mvwprintw(rightWindow, 15, 2, "%s", (COMMAND_SET_FRIDGE_LIMIT_BLUEBERRY + "^X").data());
    mvwprintw(rightWindow, 16, 2, "%s", (COMMAND_SET_FRIDGE_LIMIT_COMMONS + "^X").data());
    mvwprintw(rightWindow, 17, 2, "%s", (COMMAND_SET_BUFFET_LIMIT_BANANA + "^X").data());
    mvwprintw(rightWindow, 18, 2, "%s", (COMMAND_SET_BUFFET_LIMIT_CHOCOLATE + "^X").data());
    mvwprintw(rightWindow, 19, 2, "%s", (COMMAND_SET_BUFFET_LIMIT_BLUEBERRY + "^X").data());
    mvwprintw(rightWindow, 20, 2, "%s", (COMMAND_SET_INGREDIENTS_TO_ADD_AMOUNT + "^X").data());
    mvwprintw(rightWindow, 21, 2, "%s", (COMMAND_EXIT + "^X").data());
