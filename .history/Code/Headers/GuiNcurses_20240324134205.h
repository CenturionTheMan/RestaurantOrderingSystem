...
void GuiNcurses::DrawRight()
{
    ...
    mvwprintw(rightWindow, 19, 2, "%s", (COMMAND_SET_BUFFET_LIMIT_BANANA + "^X").data());
    mvwprintw(rightWindow, 20, 2, "%s", (COMMAND_SET_BUFFET_LIMIT_CHOCOLATE + "^X").data());
    mvwprintw(rightWindow, 21, 2, "%s", (COMMAND_SET_BUFFET_LIMIT_BLUEBERRY + "^X").data());
    
    mvwprintw(rightWindow, 22, 2, "%s", (COMMAND_SET_INGREDIENTS_TO_ADD_AMOUNT + "^X").data());
    
    mvwprintw(rightWindow, 23, 2, "%s", COMMAND_EXIT.data());
