...
void GuiNcurses::DrawContent()
{
    ...
    mvwprintw(contentWindow, 12, 25, "MANAGER STATE:");
    mvwhline(contentWindow, 11, 25, (int)'#', 18);
    mvwhline(contentWindow, 14, 25, (int)'#', 18);
    mvwprintw(contentWindow, 13, 25, "%s", "                 "); //clear previous state
    mvwprintw(contentWindow, 13, 25, "%s", tmp.data());
