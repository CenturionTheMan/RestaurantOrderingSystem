...
void GuiNcurses::DrawContent()
{
    ...
    mvwvline(contentWindow, 11, 3, (int)'#', 3);
    mvwvline(contentWindow, 11, 14, (int)'#', 3);
    mvwprintw(contentWindow, 12, 4, " GOING TO ");
    mvwprintw(contentWindow, 13, 4, "  BUFFET  ");
    mvwhline(contentWindow, 11, 3, (int)'#', 12);
    mvwhline(contentWindow, 14, 3, (int)'#', 12);
    mvwprintw(contentWindow, 15, 3, "%s", stream.str().c_str());
    stream.str(std::string());
