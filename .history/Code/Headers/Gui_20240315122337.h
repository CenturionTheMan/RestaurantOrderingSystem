...
namespace Gui
{
    ...
    const std::string SET_FRIDGE_LIMIT_BANANA = "setfridgelimitbanana";
    const std::string SET_FRIDGE_LIMIT_CHOCOLATE = "setfridgelimitchocolate";
    const std::string SET_FRIDGE_LIMIT_BLUEBERRY = "setfridgelimitblueberry";
    const std::string SET_FRIDGE_LIMIT_COMMONS = "setbuffetlimitcommons";
    const std::string SET_BUFFET_LIMIT_BANANA = "setbuffetlimitbanana";
    const std::string SET_BUFFET_LIMIT_CHOCOLATE = "setbuffetlimitchocolate";
    const std::string SET_BUFFET_LIMIT_BLUEBERRY = "setbuffetlimitblueberry";
