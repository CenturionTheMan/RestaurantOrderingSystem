...
void GuiNcurses::DrawLeft()
{
    ...
    stream << "  Pancakes " << std::setw(9) << std::right << Containers::buffet[PancakeType::BananaPancakes] 
            << "/" 
    ...
    stream << "  Pancakes " << std::setw(9) << std::right << Containers::buffet[PancakeType::BlueberryPancakes] 
            << "/" 
    ...
    stream << "  Pancakes " << std::setw(9) << std::right << Containers::buffet[PancakeType::ChocolatePancakes] 
            << "/" 
