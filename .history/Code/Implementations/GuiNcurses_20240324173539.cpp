...
void GuiNcurses::DrawContent()
{
    ...
    mvwvline(contentWindow, 18, 27, (int)'#', 3);
    mvwvline(contentWindow, 18, 38, (int)'#', 3);
    mvwprintw(contentWindow, 18, 28, " GOING TO ");
    mvwprintw(contentWindow, 19, 28, "  BUFFET  ");
    mvwhline(contentWindow, 17, 27, (int)'#', 12);
    mvwhline(contentWindow, 20, 27, (int)'#', 12);
    mvwprintw(contentWindow, 21, 27, "%s", stream.str().c_str());
    stream.str(std::string());
