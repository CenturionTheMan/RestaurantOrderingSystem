...
void Gui::PrintUserInput()
{
    ...
    << Gui::COMMAND_DELETE_COOK_CHOCOLATE + "^X" << " | " << Gui::COMMAND_DELETE_COOK_BLUEBERRY + "^X" << " | " << Gui::COMMAND_SET_BUFFET_LIMIT_BANANA + "^X" << " | "
    << Gui::COMMAND_SET_BUFFET_LIMIT_CHOCOLATE + "^X" << " | \n" << Gui::COMMAND_SET_BUFFET_LIMIT_BLUEBERRY + "^X" << " | " << Gui::COMMAND_SET_FRIDGE_LIMIT_BANANA + "^X" << " | "
