...
void Manager::CreateAndRunCook(std::mutex& mutex, PancakeType cookSpecialization)
{
    ...
    switch (cookSpecialization)
    {
        case PancakeType::BananaPancakes:
            newCook->Run(mutex, Manager::bananaPancakesLimitCondition);
            bananaCooks.push_back(newCook);
            break;
        case PancakeType::BlueberryPancakes:
            newCook->Run(mutex, Manager::blueberryPancakesLimitCondition);
            blueberryCooks.push_back(newCook);
            break;
        case PancakeType::ChocolatePancakes:
            newCook->Run(mutex, Manager::chocolatePancakesLimitCondition);
